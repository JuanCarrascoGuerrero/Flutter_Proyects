...
class _JeeMainState extends State<JeeMain> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body:Obx(()=>c.getModel.isEmpty?Center(child: CircularProgressIndicator(),)
      : Stack(
        children: [
          //////////////////////////////////////////////////////////////////BACKGROUND IMAGE
          Container(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      builder: (context)=>
                                      AlertDialog(title: Text("Would you like to download ${i.file!.substring(i.file!.length - 8)} ?"),
                                      actions: [
                                        ElevatedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context)=> PdfViewExample(url: i.file!)));}, child: Text("Yes")),
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: AssetImage("assets/dwn.png",), 
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
